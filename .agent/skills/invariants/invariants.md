---
name: invariants
description: System Invariants to ensure data consistency and simplify code.
---
# System Invariants
...
Use this skill every time you are adding new code to the system. It will help you to maintain the invariants and make the code more maintainable.

## How to use it

1. Read the invariants carefully
2. Check if the new code violates any invariants
3. If it does, modify the code to maintain the invariants
4. If it doesn't, you can proceed with the new code
